...
extern inline void port_output_at_time(port p, int data, int16_t t);
extern inline int port_output_shift_right(port p, int data);
extern inline int port_output_shift_right_at_time(port p, int data, int16_t t);
...
extern inline int port_input_at_time(port p, int16_t t);
