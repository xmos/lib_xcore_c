...
extern char chan_input_byte(chanend c);
...
extern void t_chan_output_word(REFERENCE_PARAM(transacting_chanend, c), int data);
extern void t_chan_output_byte(REFERENCE_PARAM(transacting_chanend, c), char data);
extern void t_chan_output_block(REFERENCE_PARAM(transacting_chanend, c), char buf[], int n);
...
extern void t_chan_input_block(REFERENCE_PARAM(transacting_chanend, c), char buf[], int n);
