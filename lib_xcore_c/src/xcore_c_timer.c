...
extern void _timer_setup_trigger(timer t, int time);
extern void _timer_clear_trigger(timer t);
...
extern xcore_c_error timer_setup_trigger(timer t, int time);
extern xcore_c_error timer_clear_trigger(timer t);
